...
function create_html(schematic, lib, exportFilePath, content_manipulator) {
    ...
    function addComponent(comp) {
        ...
        svg = `    <g class="${comp.Reference} ${comp.Component_Name.replace(":","-")} ${compValReference} comp" data-unit="${unit}" data-${comp.Component_Name.replace(":","-").toLowerCase()}="" data-content="${compDataContent}" action-reference="${compActionReference}"`;
