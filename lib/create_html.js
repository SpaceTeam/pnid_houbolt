...
function create_html(schematic, lib, exportFilePath, content_manipulator) {
    ...
    function addComponent(comp) {
        ...
        svg = `    <g class="${comp.Reference.replaceAll("?", "")} ${comp.Component_Name.replaceAll(":","-").replace("_Slim", "").replace("_Short", "").replace("_Small", "")} ${compValReference} comp" data-unit="${unit}" data-${comp.Component_Name.replaceAll(":","-").replace("_Slim", "").replace("_Short", "").replace("_Small", "").toLowerCase()}="" data-content="${compDataContent}" action-reference="${compActionReference}"`;
