...
function create_html(schematic, lib, content_manipulator) {
    ...
    function addComponent(comp) {
        ...
        html = `    <g class="${comp.Reference} ${comp.Component_Name.replace(":","-")} ${compValReference} comp" data-value="40" data-${comp.Component_Name.replace(":","-").toLowerCase()}="" pointer-events="bounding-box" onclick="clickEventListenever('${comp.Reference}', '${comp.Component_Name.replace(":","-")}', '${compValReference}')"`;
